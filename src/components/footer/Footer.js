                    ...
                    <div className="container footer__head--content">
                        <ul className="footer__head--left">
                            <li className="footer__head--left-item">
                                <img src="./img/fo1.webp" alt="" className="footer__head--left--img" />
                            </li>
                            <li className="footer__head--left-item">
                                <img src="./img/fo2.webp" alt="" className="footer__head--left--img" />
                            </li>
                            <li className="footer__head--left-item">
                                <img src="./img/fo3.webp" alt="" className="footer__head--left--img" />
                            </li>
                            <li className="footer__head--left-item">
                                <img src="./img/f4.webp" alt="" className="footer__head--left--img" />
                            </li>
                            <li className="footer__head--left-item">
                                <img src="./img/fo4.webp" alt="" className="footer__head--left--img" />
                            </li>
                        </ul>
